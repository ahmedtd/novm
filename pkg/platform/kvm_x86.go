...
func (vcpu *Vcpu) refreshSRegs(dirty bool) error {
	...
	if !vcpu.sregs_cached {
		...
		vcpu.sregs.interrupt_bitmap = [4]uint64{}
	}
...
func (vcpu *Vcpu) SetRegister(reg Register, val RegisterValue) error {
	...
	switch reg {
	case RAX:
		vcpu.regs.rax = uint64(val)
	case RBX:
		vcpu.regs.rbx = uint64(val)
	case RCX:
		vcpu.regs.rcx = uint64(val)
	case RDX:
		vcpu.regs.rdx = uint64(val)
	case RSI:
		vcpu.regs.rsi = uint64(val)
	case RDI:
		vcpu.regs.rdi = uint64(val)
	case RSP:
		vcpu.regs.rsp = uint64(val)
	case RBP:
		vcpu.regs.rbp = uint64(val)
	case R8:
		vcpu.regs.r8 = uint64(val)
	case R9:
		vcpu.regs.r9 = uint64(val)
	case R10:
		vcpu.regs.r10 = uint64(val)
	case R11:
		vcpu.regs.r11 = uint64(val)
	case R12:
		vcpu.regs.r12 = uint64(val)
	case R13:
		vcpu.regs.r13 = uint64(val)
	case R14:
		vcpu.regs.r14 = uint64(val)
	case R15:
		vcpu.regs.r15 = uint64(val)
	case RIP:
		vcpu.regs.rip = uint64(val)
	case RFLAGS:
		vcpu.regs.rflags = uint64(val)
	default:
...
func (vcpu *Vcpu) SetControlRegister(
	...
	switch reg {
	case CR0:
		vcpu.sregs.cr0 = uint64(val)
	case CR2:
		vcpu.sregs.cr2 = uint64(val)
	case CR3:
		vcpu.sregs.cr3 = uint64(val)
	case CR4:
		vcpu.sregs.cr4 = uint64(val)
	case CR8:
		vcpu.sregs.cr8 = uint64(val)
	case EFER:
		vcpu.sregs.efer = uint64(val)
	case APIC_BASE:
		vcpu.sregs.apic_base = uint64(val)
	default:
		return UnknownRegister
	}
...
func (vcpu *Vcpu) SetSegment(
	...
	switch seg {
	case CS:
		vcpu.sregs.cs.base = uint64(val.Base)
		vcpu.sregs.cs.limit = uint32(val.Limit)
		vcpu.sregs.cs.selector = uint16(val.Selector)
		vcpu.sregs.cs._type = uint8(val.Type)
		vcpu.sregs.cs.present = uint8(val.Present)
		vcpu.sregs.cs.dpl = uint8(val.Dpl)
		vcpu.sregs.cs.db = uint8(val.Db)
		vcpu.sregs.cs.s = uint8(val.S)
		vcpu.sregs.cs.l = uint8(val.L)
		vcpu.sregs.cs.g = uint8(val.G)
		vcpu.sregs.cs.avl = uint8(val.Avl)
		vcpu.sregs.cs.unusable = uint8(^val.Present & 0x1)
	case DS:
		vcpu.sregs.ds.base = uint64(val.Base)
		vcpu.sregs.ds.limit = uint32(val.Limit)
		vcpu.sregs.ds.selector = uint16(val.Selector)
		vcpu.sregs.ds._type = uint8(val.Type)
		vcpu.sregs.ds.present = uint8(val.Present)
		vcpu.sregs.ds.dpl = uint8(val.Dpl)
		vcpu.sregs.ds.db = uint8(val.Db)
		vcpu.sregs.ds.s = uint8(val.S)
		vcpu.sregs.ds.l = uint8(val.L)
		vcpu.sregs.ds.g = uint8(val.G)
		vcpu.sregs.ds.avl = uint8(val.Avl)
		vcpu.sregs.ds.unusable = uint8(^val.Present & 0x1)
	case ES:
		vcpu.sregs.es.base = uint64(val.Base)
		vcpu.sregs.es.limit = uint32(val.Limit)
		vcpu.sregs.es.selector = uint16(val.Selector)
		vcpu.sregs.es._type = uint8(val.Type)
		vcpu.sregs.es.present = uint8(val.Present)
		vcpu.sregs.es.dpl = uint8(val.Dpl)
		vcpu.sregs.es.db = uint8(val.Db)
		vcpu.sregs.es.s = uint8(val.S)
		vcpu.sregs.es.l = uint8(val.L)
		vcpu.sregs.es.g = uint8(val.G)
		vcpu.sregs.es.avl = uint8(val.Avl)
		vcpu.sregs.es.unusable = uint8(^val.Present & 0x1)
	case FS:
		vcpu.sregs.fs.base = uint64(val.Base)
		vcpu.sregs.fs.limit = uint32(val.Limit)
		vcpu.sregs.fs.selector = uint16(val.Selector)
		vcpu.sregs.fs._type = uint8(val.Type)
		vcpu.sregs.fs.present = uint8(val.Present)
		vcpu.sregs.fs.dpl = uint8(val.Dpl)
		vcpu.sregs.fs.db = uint8(val.Db)
		vcpu.sregs.fs.s = uint8(val.S)
		vcpu.sregs.fs.l = uint8(val.L)
		vcpu.sregs.fs.g = uint8(val.G)
		vcpu.sregs.fs.avl = uint8(val.Avl)
		vcpu.sregs.fs.unusable = uint8(^val.Present & 0x1)
	case GS:
		vcpu.sregs.gs.base = uint64(val.Base)
		vcpu.sregs.gs.limit = uint32(val.Limit)
		vcpu.sregs.gs.selector = uint16(val.Selector)
		vcpu.sregs.gs._type = uint8(val.Type)
		vcpu.sregs.gs.present = uint8(val.Present)
		vcpu.sregs.gs.dpl = uint8(val.Dpl)
		vcpu.sregs.gs.db = uint8(val.Db)
		vcpu.sregs.gs.s = uint8(val.S)
		vcpu.sregs.gs.l = uint8(val.L)
		vcpu.sregs.gs.g = uint8(val.G)
		vcpu.sregs.gs.avl = uint8(val.Avl)
		vcpu.sregs.gs.unusable = uint8(^val.Present & 0x1)
	case SS:
		vcpu.sregs.ss.base = uint64(val.Base)
		vcpu.sregs.ss.limit = uint32(val.Limit)
		vcpu.sregs.ss.selector = uint16(val.Selector)
		vcpu.sregs.ss._type = uint8(val.Type)
		vcpu.sregs.ss.present = uint8(val.Present)
		vcpu.sregs.ss.dpl = uint8(val.Dpl)
		vcpu.sregs.ss.db = uint8(val.Db)
		vcpu.sregs.ss.s = uint8(val.S)
		vcpu.sregs.ss.l = uint8(val.L)
		vcpu.sregs.ss.g = uint8(val.G)
		vcpu.sregs.ss.avl = uint8(val.Avl)
		vcpu.sregs.ss.unusable = uint8(^val.Present & 0x1)
	case TR:
		vcpu.sregs.tr.base = uint64(val.Base)
		vcpu.sregs.tr.limit = uint32(val.Limit)
		vcpu.sregs.tr.selector = uint16(val.Selector)
		vcpu.sregs.tr._type = uint8(val.Type)
		vcpu.sregs.tr.present = uint8(val.Present)
		vcpu.sregs.tr.dpl = uint8(val.Dpl)
		vcpu.sregs.tr.db = uint8(val.Db)
		vcpu.sregs.tr.s = uint8(val.S)
		vcpu.sregs.tr.l = uint8(val.L)
		vcpu.sregs.tr.g = uint8(val.G)
		vcpu.sregs.tr.avl = uint8(val.Avl)
		vcpu.sregs.tr.unusable = uint8(^val.Present & 0x1)
	case LDT:
		vcpu.sregs.ldt.base = uint64(val.Base)
		vcpu.sregs.ldt.limit = uint32(val.Limit)
		vcpu.sregs.ldt.selector = uint16(val.Selector)
		vcpu.sregs.ldt._type = uint8(val.Type)
		vcpu.sregs.ldt.present = uint8(val.Present)
		vcpu.sregs.ldt.dpl = uint8(val.Dpl)
		vcpu.sregs.ldt.db = uint8(val.Db)
		vcpu.sregs.ldt.s = uint8(val.S)
		vcpu.sregs.ldt.l = uint8(val.L)
		vcpu.sregs.ldt.g = uint8(val.G)
		vcpu.sregs.ldt.avl = uint8(val.Avl)
		vcpu.sregs.ldt.unusable = uint8(^val.Present & 0x1)
	default:
		return UnknownRegister
	}
...
func (vcpu *Vcpu) SetDescriptor(
	...
	switch desc {
	case GDT:
		vcpu.sregs.gdt.base = uint64(val.Base)
		vcpu.sregs.gdt.limit = uint16(val.Limit)
	case IDT:
		vcpu.sregs.idt.base = uint64(val.Base)
		vcpu.sregs.idt.limit = uint16(val.Limit)
	default:
		return UnknownRegister
	}
